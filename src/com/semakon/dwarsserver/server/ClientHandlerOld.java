 ...
 * Date:    27-10-2017
 */
public class ClientHandlerOld extends Thread {
    ...
    public ClientHandlerOld(int uuid, Server server, Socket socket) {
        this.uuid = uuid;
        this.server = server;
        this.socket = socket;
    ...
    public boolean equals(Object obj) {
        return this == obj || obj instanceof ClientHandlerOld && this.uuid == ((ClientHandlerOld) obj).getUuid();
    }
